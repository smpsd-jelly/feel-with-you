          ...
          <div className="bg-[#FFFEFA] shadow-lg rounded-xl p-8 w-full max-w-sm mx-auto mt-10">
            <div className="flex flex-col items-center justify-center space-y-6">
              <h2
                ...
                style={{
                  WebkitTextStroke: "0.3px #ffffff", // Stroke ขาวรอบตัวอักษร
                  textShadow: "0 2px 4px rgba(0, 0, 0, 0.2)", // Shadow เพิ่มมิติ
                }}
              >
              ...
              <button className="flex items-center justify-center bg-white border border-gray-300 rounded-full px-6 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 shadow-md transition">
